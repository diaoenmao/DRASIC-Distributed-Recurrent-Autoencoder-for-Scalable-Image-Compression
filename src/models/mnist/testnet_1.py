...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        ...
        {'cell': 'ResLSTMCell','num_layer':1,'in': encoder_in_info[0],'hidden':encoder_hidden_info[0],'shortcut':encoder_shortcut_info[0],'activation':'tanh'},
        {'cell': 'ResLSTMCell','num_layer':1,'in': encoder_in_info[1],'hidden':encoder_hidden_info[1],'shortcut':encoder_shortcut_info[1],'activation':'tanh'},
        {'cell': 'ResLSTMCell','num_layer':1,'in': encoder_in_info[2],'hidden':encoder_hidden_info[2],'shortcut':encoder_shortcut_info[2],'activation':'tanh'},
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        ...
        {'cell': 'ResLSTMCell','num_layer':1,'in': decoder_in_info[0],'hidden':decoder_hidden_info[0],'shortcut':decoder_shortcut_info[0],'activation':'tanh'},
        {'cell': 'ResLSTMCell','num_layer':1,'in': decoder_in_info[1],'hidden':decoder_hidden_info[1],'shortcut':decoder_shortcut_info[1],'activation':'tanh'},
        {'cell': 'ResLSTMCell','num_layer':1,'in': decoder_in_info[2],'hidden':decoder_hidden_info[2],'shortcut':decoder_shortcut_info[2],'activation':'tanh'},       
