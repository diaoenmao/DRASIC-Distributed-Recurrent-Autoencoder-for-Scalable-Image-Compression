...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        ...
        {'cell': 'ResCell','num_layer':1,'in': encoder_in_info[0],'shortcut':encoder_shortcut_info[0],'activation':activation},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},          
        {'cell': 'ResCell','num_layer':1,'in': encoder_in_info[1],'shortcut':encoder_shortcut_info[1],'activation':activation},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},
        {'cell': 'ResCell','num_layer':1,'in': encoder_in_info[2],'shortcut':encoder_shortcut_info[2],'activation':activation},
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        ...
        {'cell': 'ResCell','num_layer':1,'in': decoder_in_info[0],'shortcut':decoder_shortcut_info[0],'activation':activation},
        {'cell':'ShuffleCell','mode':'up','scale_factor':2},
        {'cell': 'ResCell','num_layer':1,'in': decoder_in_info[1],'shortcut':decoder_shortcut_info[1],'activation':activation},
        {'cell':'ShuffleCell','mode':'up','scale_factor':2},
        {'cell': 'ResCell','num_layer':1,'in': decoder_in_info[2],'shortcut':decoder_shortcut_info[2],'activation':activation},
        {'cell':'ShuffleCell','mode':'up','scale_factor':2},        
...
class shuffle_rescodec(nn.Module):
    def __init__(self,classes_size):
        super(shuffle_rescodec, self).__init__()
        self.classes_size = classes_size
        self.codec = Codec()
