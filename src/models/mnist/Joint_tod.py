...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        encoder_info = [        
        [{'model':'Conv2d','input_size':3,'output_size':64,'num_layers':1,'kernel_size':3,'stride':2,'padding':1,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':64,'output_size':256,'num_layers':1,'kernel_size':3,'hidden_kernel_size':1,'stride':2,'hidden_stride':1,'padding':1,'hidden_padding':0,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':256,'output_size':512,'num_layers':1,'kernel_size':3,'hidden_kernel_size':1,'stride':2,'hidden_stride':1,'padding':1,'hidden_padding':0,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':512,'output_size':512,'num_layers':1,'kernel_size':3,'hidden_kernel_size':1,'stride':2,'hidden_stride':1,'padding':1,'hidden_padding':0,'dilation':1,'bias':False}],
        [{'model':'Conv2d','input_size':512,'output_size':code_size,'num_layers':1,'kernel_size':1,'stride':1,'padding':0,'dilation':1,'bias':False}]
        ]
        return encoder_info
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        decoder_info = [
        [{'model':'Conv2d','input_size':code_size,'output_size':512,'num_layers':1,'kernel_size':1,'stride':1,'padding':0,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':512,'output_size':512,'num_layers':1,'kernel_size':3,'hidden_kernel_size':1,'stride':1,'hidden_stride':1,'padding':1,'hidden_padding':0,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':128,'output_size':512,'num_layers':1,'kernel_size':3,'hidden_kernel_size':1,'stride':1,'hidden_stride':1,'padding':1,'hidden_padding':0,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':128,'output_size':256,'num_layers':1,'kernel_size':3,'hidden_kernel_size':3,'stride':1,'hidden_stride':1,'padding':1,'hidden_padding':1,'dilation':1,'bias':False}],
        [{'model':cell_name,'input_size':64,'output_size':128,'num_layers':1,'kernel_size':3,'hidden_kernel_size':3,'stride':1,'hidden_stride':1,'padding':1,'hidden_padding':1,'dilation':1,'bias':False}],
...
class Codec(nn.Module):
    ...
    def compression_loss_fn(self, input, output, protocol):
        ...
        if(protocol['tuning_param']['compression'] > 0):
            loss = apply_along_dim(output['compression']['img'],input['img'],fn=loss_fn,dim=[1,0],reduction='mean')
            loss = loss.mean()
        else:
            loss = 0
        return loss
...
class Classifier(nn.Module):
    ...
    def classification_loss_fn(self, input, output, protocol):
        ...
        if(protocol['tuning_param']['classification'] > 0):
            loss = apply_along_dim(output['classification'],input['label'],fn=loss_fn,dim=[1,0],reduction='sum')
            loss = loss.mean()
        else:
            loss = 0
...
class Joint_tod(nn.Module):
    def __init__(self,classes_size):
        super(Joint_tod, self).__init__()
        self.classes_size = classes_size
        self.codec = Codec()
