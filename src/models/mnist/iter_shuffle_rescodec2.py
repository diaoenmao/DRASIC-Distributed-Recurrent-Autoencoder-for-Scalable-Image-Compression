...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        ...
        [{'cell':'none'}],
        [{'input_size':512,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'fc','normalization':'none','activation':'none','raw':True}],
        [{'input_size':512,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'fc','normalization':'none','activation':'none','raw':True}]           
        ]
        encoder_info = [
        ...
        {'cell': 'ResLSTMCell','num_layer':2,'in': encoder_in_info[0],'hidden':encoder_hidden_info[0],'shortcut':encoder_shortcut_info[0],'activation':activation},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},
        {'cell': 'ResLSTMCell','num_layer':2,'in': encoder_in_info[1],'hidden':encoder_hidden_info[1],'shortcut':encoder_shortcut_info[1],'activation':activation},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},
        {'cell': 'ResLSTMCell','num_layer':2,'in': encoder_in_info[2],'hidden':encoder_hidden_info[2],'shortcut':encoder_shortcut_info[2],'activation':activation},
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        ...
        [{'input_size':128,'output_size':512,'num_layer':1,'cell':'BasicCell','mode':'fc','normalization':'none','activation':'none','raw':True}],
        [{'input_size':128,'output_size':512,'num_layer':1,'cell':'BasicCell','mode':'fc','normalization':'none','activation':'none','raw':True}], 
        [{'cell':'none'}],        
        ]
        decoder_info = [
        ...
        {'cell': 'ResLSTMCell','num_layer':2,'in': decoder_in_info[0],'hidden':decoder_hidden_info[0],'shortcut':decoder_shortcut_info[0],'activation':activation},
        {'cell':'ShuffleCell','mode':'up','scale_factor':2},
        {'cell': 'ResLSTMCell','num_layer':2,'in': decoder_in_info[1],'hidden':decoder_hidden_info[1],'shortcut':decoder_shortcut_info[1],'activation':activation},
        {'cell':'ShuffleCell','mode':'up','scale_factor':2},
        {'cell': 'ResLSTMCell','num_layer':2,'in': decoder_in_info[2],'hidden':decoder_hidden_info[2],'shortcut':decoder_shortcut_info[2],'activation':activation},
        {'cell':'ShuffleCell','mode':'up','scale_factor':2},        
...
class iter_shuffle_rescodec2(nn.Module):
    def __init__(self,classes_size):
        super(iter_shuffle_rescodec2, self).__init__()
        self.classes_size = classes_size
        self.codec = Codec()
