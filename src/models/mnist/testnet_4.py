...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        ...
        {'cell': 'LSTMCell','num_layer':2,'in': encoder_in_info[0],'hidden':encoder_hidden_info[0],'activation':'tanh'},
        {'cell': 'LSTMCell','num_layer':2,'in': encoder_in_info[1],'hidden':encoder_hidden_info[1],'activation':'tanh'},
        {'cell': 'LSTMCell','num_layer':2,'in': encoder_in_info[2],'hidden':encoder_hidden_info[2],'activation':'tanh'},
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        ...
        {'cell': 'LSTMCell','num_layer':2,'in': decoder_in_info[0],'hidden':decoder_hidden_info[0],'activation':'tanh'},
        {'cell': 'LSTMCell','num_layer':2,'in': decoder_in_info[1],'hidden':decoder_hidden_info[1],'activation':'tanh'},
        {'cell': 'LSTMCell','num_layer':2,'in': decoder_in_info[2],'hidden':decoder_hidden_info[2],'activation':'tanh'},       
...
class testnet_4(nn.Module):
    def __init__(self,classes_size):
        super(testnet_4, self).__init__()
        self.classes_size = classes_size
        self.codec = Codec()
