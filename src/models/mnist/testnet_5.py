...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        encoder_in_info = [        
        [{'input_size':32,'output_size':128,'num_layer':1,'cell':cell_name,'mode':'downsample','normalization':'none','activation':'none','raw':True},
        {'input_size':128,'output_size':128,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True}],     
        [{'input_size':128,'output_size':256,'num_layer':1,'cell':cell_name,'mode':'downsample','normalization':'none','activation':'none','raw':True},
        {'input_size':256,'output_size':256,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True}], 
        [{'input_size':256,'output_size':512,'num_layer':1,'cell':cell_name,'mode':'downsample','normalization':'none','activation':'none','raw':True},
        ...
        {'input_size':512,'output_size':code_size,'num_layer':1,'cell':cell_name,'mode':'fc','normalization':'none','activation':'tanh','raw':False}
        ]
        return encoder_info
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        decoder_in_info = [ 
        [{'input_size':512,'output_size':512,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True},
        {'input_size':512,'output_size':256,'num_layer':1,'cell':cell_name,'mode':'upsample','normalization':'none','activation':'none','raw':True}],
        [{'input_size':256,'output_size':256,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True},
        {'input_size':256,'output_size':128,'num_layer':1,'cell':cell_name,'mode':'upsample','normalization':'none','activation':'none','raw':True}],
        [{'input_size':128,'output_size':128,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True},
        {'input_size':128,'output_size':32,'num_layer':1,'cell':cell_name,'mode':'upsample','normalization':'none','activation':'none','raw':True}]        
        ]
        decoder_hidden_info = [
        [{'input_size':512,'output_size':512,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True},
        {'input_size':256,'output_size':256,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True}],
        ...
        {'input_size':128,'output_size':128,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True}],
        [{'input_size':128,'output_size':128,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True},
        {'input_size':32,'output_size':32,'num_layer':1,'cell':cell_name,'mode':'pass','normalization':'none','activation':'none','raw':True}]         
        ]
        ...
        decoder_info = [
        {'input_size':code_size,'output_size':512,'num_layer':1,'cell':cell_name,'mode':'fc','normalization':'none','activation':'tanh','raw':False},     
...
class Classifier(nn.Module):
    ...
    def make_classifier_info(self):
        ...
        classifier_info = [
        {'cell': 'LSTMCell','num_layer':1,'in': classifier_in_info[0],'hidden':classifier_hidden_info[0],'activation':'tanh'},
