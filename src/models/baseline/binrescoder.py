...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        encoder_info = [
        {'input_size':3,'output_size':64,'cell':'Conv2d','kernel_size':3,'stride':1,'padding':1,'dilation':1,'bias':False,'normalization':'none','activation':'tanh'},
        {'input_size':64,'output_size':128,'num_layer':2,'cell':cell_name,'mode':'pass','normalization':'none','activation':'tanh','raw':False},
        {'input_size':128,'output_size':256,'num_layer':2,'cell':cell_name,'mode':'downsample','normalization':'none','activation':'tanh','raw':False},
        {'input_size':256,'output_size':512,'num_layer':2,'cell':cell_name,'mode':'downsample','normalization':'none','activation':'tanh','raw':False},
        {'input_size':512,'output_size':512,'num_layer':2,'cell':cell_name,'mode':'downsample','normalization':'none','activation':'tanh','raw':False},
        {'input_size':512,'output_size':code_size,'cell':'Conv2d','kernel_size':1,'stride':1,'padding':0,'dilation':1,'bias':False,'normalization':'none','activation':'tanh'}
        ]
        return encoder_info
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        decoder_info = [
        {'input_size':code_size,'output_size':512,'cell':'Conv2d','kernel_size':1,'stride':1,'padding':0,'dilation':1,'bias':False,'normalization':'none','activation':'tanh'},
        {'input_size':512,'output_size':512,'num_layer':2,'cell':cell_name,'mode':'upsample','normalization':'none','activation':'tanh','raw':False},
        {'input_size':512,'output_size':256,'num_layer':2,'cell':cell_name,'mode':'upsample','normalization':'none','activation':'tanh','raw':False},
        {'input_size':256,'output_size':128,'num_layer':2,'cell':cell_name,'mode':'upsample','normalization':'none','activation':'tanh','raw':False},
        {'input_size':128,'output_size':64,'num_layer':2,'cell':cell_name,'mode':'pass','normalization':'none','activation':'tanh','raw':False},
...
class binrescoder(nn.Module):
    def __init__(self,classes_size):
        super(binrescoder, self).__init__()
        self.classes_size = classes_size
        self.codec = Codec()
    ...
    def forward(self, input, protocol):
        ...
        code = self.codec.embedding(encoded)
